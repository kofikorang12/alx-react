        ...
        !(function (e, n) {
          ...
          function Vt(t, e, n) {
            ...
            return (
              (n = n || $t(t)) &&
                ...
                a && u && (u = u.replace(Xt, "$1") || void 0),
                "" !== u || at(t) || (u = C.style(t, e)),
                !g.pixelBoxStyles() &&
                  Mt.test(u) &&
                  Ft.test(e) &&
                  ((r = s.width),
          ...
          function de(t, e, n) {
            ...
            for (
              ...
              if ((r = de.prefilters[o].call(c, t, f, c.opts)))
                return (
                  y(r.stop) &&
                ...
                return (
                  ...
                  this.each(function () {
                    ...
                    if (i) u[i] && u[i].stop && r(u[i]);
                      ...
                      for (i in u) u[i] && u[i].stop && ce.test(i) && r(u[i]);
                    for (i = o.length; i--; )
                      o[i].elem !== this ||
                        (null != t && o[i].queue !== t) ||
                  ...
                  ? this.each(function () {
                      if (
                        ...
                        for (o = 0; o < e.length; o++)
                          (i = e[o]),
                            n.indexOf(" " + i + " ") < 0 && (n += i + " ");
                        (u = be(n)), r !== u && this.setAttribute("class", u);
                      }
                    })
                  : this;
              },
                  ...
                  : ((n = xe(t)),
                    this.each(function () {
                      if (a)
                        ...
                        (void 0 !== t && "boolean" !== u) ||
                          ((r = _e(this)) && J.set(this, "__className__", r),
                          this.setAttribute &&
                            this.setAttribute(
                              "class",
                              r || !1 === t
          ...
          C.ajaxSetup({
            ...
            C.each(["top", "left"], function (t, e) {
              C.cssHooks[e] = Gt(g.pixelPosition, function (t, n) {
                if (n)
                  return (
                    (n = Vt(t, e)), Mt.test(n) ? C(t).position()[e] + "px" : n
                  );
              });
            }),
              ...
              vn = (function t(e) {
                var n,
                  r = (e =
                    null == e
                      ? le
                      : vn.defaults(le.Object(), e, vn.pick(le, ne))).Array,
                  it = e.Date,
                  xt = e.Error,
                  wt = e.Function,
                  Tt = e.Math,
                  ...
                  Bt = e.Symbol,
                  $t = e.Uint8Array,
                  zt = Mt ? Mt.allocUnsafe : i,
                  Ft = an(Ct.getPrototypeOf, Ct),
                  Ut = Ct.create,
                ...
                function Zn(t, e) {
                  return qo(Si(t), ur(e, 0, t.length));
                }
                function Jn(t) {
                  return qo(Si(t));
                }
                ...
                function Er(t, e, n) {
                  ...
                  t: for (; ++h < u && l.length < f; ) {
                    ...
                    if (
                      ...
                      for (s = a; --s; ) {
                        var y = c[s];
                        if (!(y ? Ze(y, g) : o(t[s], g, n))) continue t;
                      }
                      d && d.push(g), l.push(v);
                    }
                  }
                ...
                function Wr(t, e) {
                  return bo(t) && To(e)
                    ...
                    : function (n) {
                        var r = Sa(n, t);
                        return r === i && r === e ? Ea(n, t) : Nr(e, r, 3);
                      };
                }
                ...
                function Fr(t, e, n, r) {
                  ...
                  for (
                    ...
                    for (
                      ...
                      a !== t && Vt.call(a, s, 1), Vt.call(t, s, 1);
                  return t;
                }
                function Ur(t, e) {
                  for (var n = t ? e.length : 0, r = n - 1; n--; ) {
                    ...
                    if (n == r || i !== o) {
                      var o = i;
                      yo(i) ? Vt.call(t, i, 1) : ci(t, i);
                    }
                  }
                  return t;
                }
                function Xr(t, e) {
                  return t + he(xn() * (e - t + 1));
                }
                function Vr(t, e) {
                  var n = "";
                ...
                function qi(t) {
                  return function (e) {
                    return Oe(Ja(Fa(e).replace(Kt, "")), t, "");
                  };
                }
                function Ri(t) {
                  return function () {
                ...
                function $i(t, e) {
                  ...
                  var r = Vr(e, pe(t / ln(e)));
                  return on(e) ? bi(pn(r), 0, t).join("") : r.slice(0, t);
                }
                function zi(t) {
                ...
                function Ui(t, e, n, r, o, u, a, c, f, l) {
                  ...
                  var h = [
                    ...
                    d = n.apply(i, h);
                  return _o(t) && ko(d, h), (d.placeholder = r), Lo(d, t, e);
                }
                function Xi(t) {
                  var e = Tt[t];
                  return function (t, n) {
                ...
                function So(t, e) {
                  for (
                    var n = t.length, r = mn(e.length, n), o = Si(t);
                    r--;
                ...
                function Fo(t, e, n) {
                  ...
                  if (!r) return -1;
                  var i = null == n ? 0 : va(n);
                  return i < 0 && (i = yn(r + i, 0)), Pe(t, uo(e, 3), i);
                }
                function Uo(t, e, n) {
                  var r = null == t ? 0 : t.length;
                  if (!r) return -1;
                ...
                var au = Gr(function (t, e) {
                  ...
                  cu = Gr(function (t) {
                    var e = Zo(t);
                    return Gu(e) && (e = i), hi(Ee(t, Gu), uo(e, 2));
                  }),
                  fu = Gr(function (t) {
                    var e = Zo(t);
                    return (
                      (e = "function" == typeof e ? e : i), hi(Ee(t, Gu), i, e)
                    );
                  }),
                  lu = Gr(ou),
                  pu = Gr(function (t) {
                ...
                var vu = to(function (t) {
                  ...
                  mu = Ii(Uo);
                function bu(t, e) {
                  return (Uu(t) ? Ae : lr)(t, uo(e, 3));
                }
                function _u(t, e) {
                  return (Uu(t) ? je : pr)(t, uo(e, 3));
                }
                var xu = ki(function (t, e, n) {
                ...
                var $u = Fi(Ar),
                  ...
                  Fu = Dr(
                    ...
                    : function (t) {
                        return (
                          na(t) && Ot.call(t, "callee") && !Xt.call(t, "callee")
                        );
                      },
                  Uu = r.isArray,
                  Xu = ye
                ...
                function sa(t) {
                  return (
                    "string" == typeof t || (!Uu(t) && na(t) && Cr(t) == E)
                  );
                }
                function ca(t) {
                ...
                var fa = we
                    ? Ye(we)
                    : function (t) {
                        return na(t) && ta(t.length) && !!ie[Cr(t)];
                      },
                  la = Fi(Ir),
                  pa = Fi(function (t, e) {
                    return t <= e;
                ...
                function Fa(t) {
                  return (t = ba(t)) && t.replace(mt, en).replace(Zt, "");
                }
                ...
                return (
                  ...
                  (Wn.chunk = function (t, e, n) {
                    ...
                    if (!o || e < 1) return [];
                    for (var u = 0, a = 0, s = r(pe(o / e)); u < o; )
                      s[a++] = ei(t, u, (u += e));
                    return s;
                  }),
                  ...
                  (Wn.toPath = function (t) {
                    return Uu(t) ? Ne(t, Po) : ca(t) ? [t] : Si(Ho(ba(t)));
                  }),
                  (Wn.toPlainObject = ma),
                  ...
                  (Wn.escape = function (t) {
                    return (t = ba(t)) && G.test(t) ? t.replace(X, nn) : t;
                  }),
                  ...
                  (Wn.findKey = function (t, e) {
                    return He(t, uo(e, 3), br);
                  }),
                  (Wn.findLast = mu),
                  (Wn.findLastIndex = Uo),
                  (Wn.findLastKey = function (t, e) {
                    return He(t, uo(e, 3), _r);
                  }),
                  (Wn.floor = ws),
                  (Wn.forEach = bu),
                  (Wn.forEachRight = _u),
                  ...
                  (Wn.size = function (t) {
                    if (null == t) return 0;
                    if (Vu(t)) return sa(t) ? ln(t) : t.length;
                    var e = po(t);
                    return e == w || e == S ? t.size : Rr(t).length;
                  }),
                  (Wn.snakeCase = Ga),
                  ...
                  (Wn.trim = function (t, e, n) {
                    ...
                    var r = pn(t),
                      o = pn(e);
                    return bi(r, Je(r, o), Qe(r, o) + 1).join("");
                  }),
                  ...
                  (Wn.unescape = function (t) {
                    return (t = ba(t)) && V.test(t) ? t.replace(U, dn) : t;
                  }),
  ...
  (n.n = (t) => {
    ...
    (() => {
      ...
      e()("button").on(
        "click",
        i().debounce(function () {
          (o += 1), e()("#count").text(`${o} clicks on the button`);
        }, 500)
      );
    })();
})();
