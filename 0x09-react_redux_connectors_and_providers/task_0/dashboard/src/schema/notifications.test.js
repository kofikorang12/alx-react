...
describe('getAllNotificationsByUser', () => {
    ...
    // Tests that the function returns an array of notification contexts with no duplicate values
    it('should return an array of notification contexts with no duplicate values', () => {
